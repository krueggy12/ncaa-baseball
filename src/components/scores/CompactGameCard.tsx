    ...
    >
      ...
      <div className={`flex items-center justify-between px-2.5 py-1.5 border-b ${
        ...
        {isLive ? (
          ...
          <div className="flex items-center gap-1.5 min-w-0">
            <span className="text-[10px] font-bold text-white/55 leading-none shrink-0">{gameTime}</span>
            {game.broadcasts.length > 0 && (
              <span className="text-[9px] text-white/25 truncate">{game.broadcasts[0]}</span>
            )}
          </div>
        )}
        {game.isConferenceGame && (
      ...
      <div className="px-2.5 py-2 space-y-2">
        ...
        <div className="flex items-center gap-1.5">
          ...
          {(isLive || isFinal) && (
            <span className={`text-[15px] font-black tabular-nums shrink-0 leading-none ${
